  ...
  loadData() {
    ...
    $.ajax({
      ...
      success: function(res) {
        ...
        this.setState({
          companyDetails: Object.assign({}, res.employer.companyContact)
        });
      }.bind(this),
      error: function(res) {
      ...
      <Card>
        <Card.Content>
          <Card.Header textAlign="center">
            <Icon name="picture" circular color="grey" />
            <br />
            {companyDetails.name}
          </Card.Header>
        ...
        <Card.Content>
          <a>
            <Icon name="phone" />: {companyDetails.phone}
          </a>
          <br />
          <a>
            <Icon name="mail" />: {companyDetails.email}
          </a>
        </Card.Content>
      </Card>
    );
